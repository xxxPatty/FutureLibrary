function start(){
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            if(response.borrowing.length==0){
            ...
            for(var i=0; i<response.borrowing.length; i++){
                ...
                content += 'ms;">';
                    ...
                    var tempURL = "http://localhost:5000/read_image?book_id="+response.borrowing[i];
                    $.ajax({
                        url: tempURL,
                        type: "GET",
                        dataType: "json",
                    ...
                    tempURL = "http://localhost:5000/show_book_by_id?book_id="+response.borrowing[i];
